# V11 final candidate report

Candidate identity: `HEAD (the Git commit containing this report)`. The draft PR head and its exact-SHA validation run provide the concrete immutable SHA.
...
- Baseline: `f91f15002256ec63ecd258fa5443834ce8a0244c`
- Public pages: 23
