...
- V8 Products baseline: 137,176-byte HTML; 45 full-detail cards; 1,760 initial DOM nodes; 49,722px page height at 375px; first product Y 2,485px; product 6 Y 6,997px; product 12 Y 13,143px; 931px median card height.
- V8 active product-image payload: 1,103,598 bytes across the 45 reused optimized cutouts.
- V5.1 annotated tag still dereferences to `b5d35772e98580e253c08f6319aa8e412fa20aea`.

Repository evidence, not prior conversational summaries, is authoritative.
