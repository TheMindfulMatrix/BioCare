...
def evidence_for(number: int) -> str:
    evidence = {
        ...
        range(38, 51): "The standalone relevance module, 70-record index, automated ranking fixtures, and browser query matrix prove deterministic factual ranking, grouping, counts, URL behavior, and deduplication.",
        ...
        range(92, 106): "Performance, image payload, privacy, evidence, compliance, 46 tests, metadata, sitemap, JSON-LD, screenshots, reports, and warning reconciliation are recorded and pass.",
