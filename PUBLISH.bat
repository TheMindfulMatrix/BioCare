...
git add index.html shop.html library.html start.html robots.txt sitemap.xml assets content templates scripts .github .gitignore README.md PUBLISH.bat img
